<template>
    ...
    >
        ...
        <template #empty>
            <div class="text-center">Keine Kurse gefunden.</div>
        </template>
        <template #loading>
...
defineEmits<{
    editButtonClicked: [Database["public"]["Tables"]["course"]["Row"]];
}>();
...
const courses = ref<Array<Database["public"]["Tables"]["course"]["Row"]>>();
